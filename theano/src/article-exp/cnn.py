            ...
            if (iter + 1) % validation_frequency == 0:
                ...
                if this_validation_loss < best_validation_loss:
                    ...
                    print(('     epoch %i, minibatch %i/%i, test error of '
                          ...
                          (epoch, minibatch_index + 1, n_train_batches,
                           test_score * 100.))
                    save_file = open('/home/dmitry/Projects/DNN-develop/theano/results/LeNet5', 'wb')
                    cPickle.dump(layer0.W.get_value(borrow=True), save_file, -1)
                    cPickle.dump(layer0.b.get_value(borrow=True), save_file, -1)
